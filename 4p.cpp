...
iv. Change a tree so that the roles of the left and right pointers are swapped at every node (Mirror Image).
v. Search a value 
*/
#include<iostream>
#include<stdlib.h>
...
void tree::se\archgiven(BSTnode *root1,int elm,int count)
{
		if(root1==NULL)
